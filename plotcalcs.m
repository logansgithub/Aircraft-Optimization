function [cd,clmax,Vstall,K,Vcruise,Vdmin,R,E,Max,e,delta_tr,vmax] = plotcalcs(WF,b,c_root,c_tip,S,tc,tr,c,D,lf,ch,cv,Sh,Sv,Delta,W,density,A,Wfinal,eff,fc,Pav)
...
figure
hold on
title('Power Required for level flight');
plot(vel,P,'LineWidth',2);
y=3.4;
plot([0,400],[y,y],'-.r');
xlabel('Velocity [ft/s]');
